...
/**
 * The standardized Space of Tic-Tac-Toe. Space stores the appropriate null, X,
 * or O data value and acts as a button for sending action events.
 * 
...
public class Space extends JButton
{
	...
	public void scaleIconToGameBoard(GameBoard board)
	{
		...
		/*
		 * Scale the images to fit within the grid. Required since display resolutions
		 * will vary
		 */
		ImageIcon imageIconX = new ImageIcon(
				imgX.getScaledInstance((int) (board.getHeight() / 4.0), -1, java.awt.Image.SCALE_SMOOTH)
		);
		ImageIcon imageIconO = new ImageIcon(
				imgO.getScaledInstance((int) (board.getHeight() / 4.0), -1, java.awt.Image.SCALE_SMOOTH)
		);

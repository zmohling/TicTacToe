...
public class TicTacToe implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		/*
		 * Check the grid for a winner or end the game in a draw if nine or more moves
		 * had been made
		 */
		if (checkWin(player))
		{
	...
	private void instantiateGameBoard(GameBoard board)
	{
		...
		for (int i = 0; i < (Constants.ROWS * Constants.COLS); i++)
		{
			...
			spaces[i].addActionListener(this); // The Space class extends JButton. When pressed, our action listener

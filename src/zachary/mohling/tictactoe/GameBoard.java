...
public class GameBoard extends JFrame {
	...
	public GameBoard()
	{
		...
		this.addComponentListener(new ComponentAdapter() {
			...
			public void componentResized(ComponentEvent e)
			{
				...
				e.getComponent().setBounds(window.x, window.y, returnLargerDifference(initialGameBoardDimensions[0], window.width, initialGameBoardDimensions[1], window.height), returnLargerDifference(initialGameBoardDimensions[0], window.width, initialGameBoardDimensions[1], window.height));		// Maintain aspect ratio of 1x1
	...
	/**
	 * Returns the integer with the larger difference between its current value and its initial value.
	 ...
	 * @return integer with the larger difference between its current value and its initial value
	 */
